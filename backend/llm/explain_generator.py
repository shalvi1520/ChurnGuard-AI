...
risk + the model's baseline risk + real SHAP driver breakdown and returns
an LLM-written plain-English paragraph, plus which provider generated it.
"""
...
def generate_explanation_summary(
    ...
    messages = prompts.build_explain_messages(customer_id, risk_score, baseline_risk, drivers)
